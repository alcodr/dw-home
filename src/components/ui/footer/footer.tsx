...
const Footer = () => {
    return <>
        <section className='p-12'>
            <div>
                <div className='flex xl:flex-nowrap xl:flex-row xl:items-end items-start flex-col flex-wrap justify-between gap-[50px]'>
                    <div className='flex flex-col gap-[30px]'>
                        ...
                        <p className='lg:w-3/5'>{footerCopy}</p>
                    </div>
                    <div className='flex flex-col justify-between h-min gap-[30px] lg:flex-row md:items-start md:gap-unset xl:gap-[150px] w-full'>
                        <div className='flex flex-col justify-center flex-none gap-[20px]'>
                            <h6 className='font-medium'>Page</h6>
                            {footerNavigation.page.map((page) => {
                                return (
                                    <div>{page}</div>
                                )
                            })}
                        ...
                        <div className='flex flex-col justify-center flex-none gap-[20px]'>
                            ...
                            {footerNavigation.company.map((company) => {
                                return (
                                    <div>{company}</div>
                                )
                            })}
                        ...
                        <div className='flex flex-col justify-center flex-none gap-[20px]'>
                            ...
                            {footerNavigation.legal.map((legal) => {
                                return (
                                    <div>{legal}</div>
                                )
                            })}
            ...
            <div className='my-16 border-b border-black opacity-[.05]'></div>
            <section className='flex flex-col items-start md:flex-row md:justify-between md:items-center'>
                ...
                <div className='text-xs opacity-50 order-2 md:order-1'>
                    {footerCopyright}
                </div>
            </section>
        </section>
